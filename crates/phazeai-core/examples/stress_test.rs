use phazeai_core::agent::multi_agent::{MultiAgentOrchestrator, AgentTask, MultiAgentEvent, AgentRole};
...
async fn main() -> Result<(), PhazeError> {
    ...
    let base_url = settings.llm.base_url.unwrap_or_else(|| "http://localhost:11434".to_string());
