...
pub fn default_keybindings() -> Vec<Keybinding> {
    vec![
        ...
        Keybinding {
            key: Key::K,
            modifiers: Modifiers::COMMAND,
            action: Action::InlineChat,
        },
        Keybinding {
            key: Key::D,
            modifiers: Modifiers::COMMAND,
            action: Action::SelectNextOccurrence,
        },
        Keybinding {
            key: Key::H,
            modifiers: Modifiers::COMMAND,
        ...
        Keybinding {
            key: Key::F,
            modifiers: Modifiers::ALT.plus(Modifiers::SHIFT),
            action: Action::FormatDocument,
        },
    ]
}
